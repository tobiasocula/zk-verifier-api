    ...
    return class Provider extends ProviderType {
        ...
        async getGasPerPubdata() {
            return await this.send('zks_gasPerPubdata', []).catch(_ => {
                ...
                return BigInt(utils_1.DEFAULT_GAS_PER_PUBDATA_LIMIT);
            });
        }
        /**
         ...
         */
        async getLogProof(txHash, index, interopMode) {
        ...
        async isEthBasedChain() {
            ...
            const assetId = (0, utils_1.encodeNativeTokenVaultAssetId)(l1ChainId, utils_1.ETH_ADDRESS_IN_CONTRACTS);
            return (0, utils_1.isAddressEq)(baseAssetId, assetId);
        }
        /**
        ...
        async isBaseToken(token) {
            ...
            const baseAssetId = await ntv.BASE_TOKEN_ASSET_ID();
            const l1ChainId = await ntv.L1_CHAIN_ID();
            const assetId = (0, utils_1.encodeNativeTokenVaultAssetId)(l1ChainId, token);
            return (0, utils_1.isAddressEq)(baseAssetId, assetId);
        }
        /**
        ...
        async getDefaultBridgeAddresses() {
            if (!this.contractAddresses().erc20BridgeL1) {
                ...
                const erc20L2Bridge = (await this.connectL2Bridge(utils_1.L2_ASSET_ROUTER_ADDRESS));
                this.contractAddresses().sharedBridgeL2 = utils_1.L2_ASSET_ROUTER_ADDRESS;
                this.contractAddresses().erc20BridgeL2 = utils_1.L2_ASSET_ROUTER_ADDRESS;
                this.contractAddresses().wethBridgeL1 = ethers_1.ethers.ZeroAddress;
                this.contractAddresses().wethBridgeL2 = ethers_1.ethers.ZeroAddress;
                this.contractAddresses().sharedBridgeL1 =
                    await assetRouter.L1_ASSET_ROUTER();
                this.contractAddresses().erc20BridgeL1 = ethers_1.ethers.ZeroAddress; //FIXME
