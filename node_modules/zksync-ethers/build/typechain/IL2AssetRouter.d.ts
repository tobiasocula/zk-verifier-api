...
export interface IL2AssetRouterInterface extends Interface {
    getFunction(nameOrSignature: "BRIDGE_HUB" | "L1_ASSET_ROUTER" | "assetHandlerAddress" | "finalizeDeposit" | "finalizeDepositLegacyBridge" | "setAssetHandlerAddress" | "setAssetHandlerAddressThisChain" | "setLegacyTokenAssetHandler" | "withdraw" | "withdrawLegacyBridge"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AssetDeploymentTrackerRegistered" | "AssetHandlerRegistered" | "BridgehubDepositBaseTokenInitiated" | "BridgehubDepositInitiated" | "BridgehubWithdrawalInitiated" | "DepositFinalizedAssetRouter" | "WithdrawalInitiatedAssetRouter"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "finalizeDepositLegacyBridge", values: [AddressLike, AddressLike, AddressLike, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "setAssetHandlerAddress", values: [BigNumberish, BytesLike, AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "withdrawLegacyBridge", values: [AddressLike, AddressLike, BigNumberish, AddressLike]): string;
...
export declare namespace AssetDeploymentTrackerRegisteredEvent {
    type InputTuple = [
        assetId: BytesLike,
...
export declare namespace AssetHandlerRegisteredEvent {
    ...
    type OutputTuple = [assetId: string, _assetHandlerAddress: string];
    interface OutputObject {
        assetId: string;
...
export declare namespace WithdrawalInitiatedAssetRouterEvent {
    type InputTuple = [
        chainId: BigNumberish,
...
export interface IL2AssetRouter extends BaseContract {
    ...
    getFunction(nameOrSignature: "finalizeDepositLegacyBridge"): TypedContractMethod<[
        _l1Sender: AddressLike,
        _l2Receiver: AddressLike,
        _l1Token: AddressLike,
        _amount: BigNumberish,
    ...
    getFunction(nameOrSignature: "setAssetHandlerAddress"): TypedContractMethod<[
        _originChainId: BigNumberish,
        _assetId: BytesLike,
        _assetHandlerAddress: AddressLike
    ], [
    ...
    getFunction(nameOrSignature: "setLegacyTokenAssetHandler"): TypedContractMethod<[_assetId: BytesLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "withdrawLegacyBridge"): TypedContractMethod<[
        _l1Receiver: AddressLike,
        _l2Token: AddressLike,
        _amount: BigNumberish,
        _sender: AddressLike
    ...
    getEvent(key: "AssetDeploymentTrackerRegistered"): TypedContractEvent<AssetDeploymentTrackerRegisteredEvent.InputTuple, AssetDeploymentTrackerRegisteredEvent.OutputTuple, AssetDeploymentTrackerRegisteredEvent.OutputObject>;
    ...
    getEvent(key: "WithdrawalInitiatedAssetRouter"): TypedContractEvent<WithdrawalInitiatedAssetRouterEvent.InputTuple, WithdrawalInitiatedAssetRouterEvent.OutputTuple, WithdrawalInitiatedAssetRouterEvent.OutputObject>;
    filters: {
        "AssetDeploymentTrackerRegistered(bytes32,bytes32,address)": TypedContractEvent<AssetDeploymentTrackerRegisteredEvent.InputTuple, AssetDeploymentTrackerRegisteredEvent.OutputTuple, AssetDeploymentTrackerRegisteredEvent.OutputObject>;
        AssetDeploymentTrackerRegistered: TypedContractEvent<AssetDeploymentTrackerRegisteredEvent.InputTuple, AssetDeploymentTrackerRegisteredEvent.OutputTuple, AssetDeploymentTrackerRegisteredEvent.OutputObject>;
        ...
        "WithdrawalInitiatedAssetRouter(uint256,address,bytes32,bytes)": TypedContractEvent<WithdrawalInitiatedAssetRouterEvent.InputTuple, WithdrawalInitiatedAssetRouterEvent.OutputTuple, WithdrawalInitiatedAssetRouterEvent.OutputObject>;
        WithdrawalInitiatedAssetRouter: TypedContractEvent<WithdrawalInitiatedAssetRouterEvent.InputTuple, WithdrawalInitiatedAssetRouterEvent.OutputTuple, WithdrawalInitiatedAssetRouterEvent.OutputObject>;
    };
}
