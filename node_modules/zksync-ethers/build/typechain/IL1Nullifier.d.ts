...
export interface IL1NullifierInterface extends Interface {
    getFunction(nameOrSignature: "BRIDGE_HUB" | "bridgeRecoverFailedTransfer" | "bridgehubConfirmL2TransactionForwarded" | "chainBalance" | "claimFailedDeposit" | "claimFailedDepositLegacyErc20Bridge" | "depositHappened" | "finalizeDeposit" | "finalizeWithdrawal" | "isWithdrawalFinalized" | "l1NativeTokenVault" | "l2BridgeAddress" | "legacyBridge" | "nullifyChainBalanceByNTV" | "setL1AssetRouter" | "setL1NativeTokenVault" | "transferTokenToNTV"): FunctionFragment;
