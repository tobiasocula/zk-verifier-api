...
export interface IL1NativeTokenVaultInterface extends Interface {
    getFunction(nameOrSignature: "ASSET_ROUTER" | "L1_CHAIN_ID" | "L1_NULLIFIER" | "WETH_TOKEN" | "assetId" | "bridgeCheckCounterpartAddress" | "calculateCreate2TokenAddress" | "chainBalance" | "ensureTokenIsRegistered" | "getERC20Getters" | "originChainId" | "registerEthToken" | "registerToken" | "tokenAddress" | "tryRegisterTokenFromBurnData"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "bridgeCheckCounterpartAddress", values: [BigNumberish, BytesLike, AddressLike, AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "bridgeCheckCounterpartAddress", data: BytesLike): Result;
...
export interface IL1NativeTokenVault extends BaseContract {
    ...
    getFunction(nameOrSignature: "bridgeCheckCounterpartAddress"): TypedContractMethod<[
        _chainId: BigNumberish,
        _assetId: BytesLike,
        _originalCaller: AddressLike,
        _assetHandlerAddressOnCounterpart: AddressLike
    ...
    getFunction(nameOrSignature: "tryRegisterTokenFromBurnData"): TypedContractMethod<[
        _burnData: BytesLike,
        _expectedAssetId: BytesLike
    ], [
        void
