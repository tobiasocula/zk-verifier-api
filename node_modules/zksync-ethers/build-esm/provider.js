...
export function JsonRpcApiProvider(ProviderType) {
    return class Provider extends ProviderType {
        ...
        async isEthBasedChain() {
            ...
            const assetId = encodeNativeTokenVaultAssetId(l1ChainId, ETH_ADDRESS_IN_CONTRACTS);
        ...
        async getDefaultBridgeAddresses() {
            if (!this.contractAddresses().erc20BridgeL1) {
                ...
                const erc20L2Bridge = (await this.connectL2Bridge(L2_ASSET_ROUTER_ADDRESS));
